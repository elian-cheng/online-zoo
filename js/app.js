(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            new core(".animals-slider", {
                ...
                navigation: {
                    prevEl: ".animals-slider__button-prev",
                    nextEl: ".animals-slider__button-next"
                },
                breakpoints: {
                    321: {
                        slidesPerView: 1,
                ...
                on: {
                    slideChangeTransitionStart: changeSlides()
                }
            });
            new core(".testimonials-slider", {
                modules: [ Scrollbar ],
                slidesPerView: 4,
                slidesPerGroup: 1,
                spaceBetween: 30,
                ...
                scrollbar: {
                    el: ".slider-testimonials__scrollbar",
                    draggable: true,
                    dragSize: 100
                },
                breakpoints: {
    ...
    function changeSlides() {
        let slideColumn1 = document.querySelector("#slide-1");
        let slideColumn2 = document.querySelector("#slide-2");
        let slideColumn3 = document.querySelector("#slide-3");
        let slideColumn4 = document.querySelector("#slide-4");
        let slideColumn5 = document.querySelector("#slide-5");
        let slideColumn6 = document.querySelector("#slide-6");
        let slideColumn7 = document.querySelector("#slide-7");
        let slideColumn8 = document.querySelector("#slide-8");
        let slideColumn9 = document.querySelector("#slide-9");
        for (let i = slideColumn1.children.length; i >= 0; i--) {
            slideColumn1.appendChild(slideColumn1.children[Math.random() * i | 0]);
            slideColumn2.appendChild(slideColumn2.children[Math.random() * i | 0]);
            slideColumn3.appendChild(slideColumn3.children[Math.random() * i | 0]);
            slideColumn4.appendChild(slideColumn4.children[Math.random() * i | 0]);
            slideColumn5.appendChild(slideColumn5.children[Math.random() * i | 0]);
            slideColumn6.appendChild(slideColumn6.children[Math.random() * i | 0]);
            slideColumn7.appendChild(slideColumn7.children[Math.random() * i | 0]);
            slideColumn8.appendChild(slideColumn8.children[Math.random() * i | 0]);
            slideColumn9.appendChild(slideColumn9.children[Math.random() * i | 0]);
        }
        for (let i = slideColumn1.children.length; i >= 0; i--) {
            slideColumn1.appendChild(slideColumn1.children[Math.random() * i | 0]);
            slideColumn2.appendChild(slideColumn2.children[Math.random() * i | 0]);
    ...
    (function inputValue() {
        ...
        const anotherInput = document.querySelector(".donation-form__input");
        if (options.length > 0) for (let i = 0; i < options.length; i++) {
            const option = options[i];
            option.addEventListener("change", (function() {
                anotherInput.value = option.value;
            }));
            anotherInput.addEventListener("input", (function() {
                if (anotherInput.value === option.value) option.checked = true; else option.checked = false;
            }));
        }
    })();
    window["FLS"] = true;
